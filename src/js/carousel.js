...
function carouseCalculateOffset() {
...
function slide(wrapper, items) {
    ...
    function dragStart(even){
        ...
        if(even.type == "touchstart"){
            console.log(even.touchs)
            posX1 = even.touchs[0].clientX
        } else {
            posX1 = even.clientX
...
if(carouselId) {
    ...
    window.addEventListener("load", carouseCalculateOffset)
    window.addEventListener("resize", carouseCalculateOffset)
}